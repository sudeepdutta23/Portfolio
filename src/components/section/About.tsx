        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[90px] items-center">
          <div className="relative space-y-4 md:space-y-0">
            ...
            <div className="top-[120px] -left-20 md:absolute">
              <div
                className={`flex gap-[17px] items-center pt-[15px] pr-[30px] pb-[11px] pl-[26px] bg-white dark:bg-semilight shadow-[25px_0px_65px_rgba(54,32,152,0.11)] rounded-lg ${
                  isDark && "text-white semi_dark_theme"
                }`}
              >
